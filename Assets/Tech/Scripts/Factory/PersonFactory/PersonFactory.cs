...
public class PersonFactory : AbstractPersonFactory
{
    ...
    public override Driver GetDriver()
    {
        ...
        bool isPictureFake = false;
        isPictureFake = isPictureFake.RandomBool(5);
        ...
        bool isNameFake = false;
        //isNameFake = isNameFake.RandomBool(5);

        DriverData driverData = new DriverData(name, licensePlateNumber, gender, picture, isPictureFake, isNameFake, false);
